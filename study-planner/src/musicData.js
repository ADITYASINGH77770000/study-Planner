...
export const MUSIC_BY_MOOD = {
  exhausted: {
    ...
    playlists: [
      { name: "Lo-Fi Sleep & Study", platform: "Spotify", url: "https://open.spotify.com/playlist/0vvXsWCC9xrXsKd4e", icon: "", genre: "Lo-Fi" },
      { name: "Peaceful Piano", platform: "Spotify", url: "https://open.spotify.com/playlist/37i9dQZF1DX4sWSpwq3LiO", icon: "", genre: "Classical" },
      { name: "Sleep & Relaxation", platform: "YouTube", url: "https://www.youtube.com/results?search_query=relaxing+sleep+music+for+studying", icon: "", genre: "Ambient" },
    ],
    artists: ["Max Richter", "lafur Arnalds", "Brian Eno", "Nils Frahm"],
    tips: [
      " Keep volume low  under 50%",
      " Avoid lyrics when reading/writing",
      " Take a real break before studying",
    ],
  ...
  stressed: {
    ...
    playlists: [
      { name: "Nature Sounds + Rain", platform: "YouTube", url: "https://www.youtube.com/results?search_query=rain+sounds+study+focus", icon: "", genre: "Nature" },
  ...
  meh: {
    ...
    playlists: [
      ...
      { name: "Chill Study Vibes", platform: "Spotify", url: "https://open.spotify.com/playlist/37i9dQZF1DX8Uebhn9wzrS", icon: "", genre: "Chill" },
    ...
    artists: ["Nujabes", "J Dilla", "Tomppabeats", "L'indcis"],
    tips: [
...
export const AFTER_STUDY_MUSIC = {
  exhausted: {
    ...
    suggestions: [
      { name: "Sleep Sounds / Rain", url: "https://www.youtube.com/results?search_query=rain+sounds+sleep+relaxing", icon: "" },
  ...
  energized: {
    ...
    suggestions: [
      { name: "Workout Mix", url: "https://www.youtube.com/results?search_query=workout+gym+music+playlist", icon: "" },
